...
class MultiTeacherPlus:
    ...
    def _build_model(self, word_vectors):
        ...
        kdloss_t1 = label_kdfunc(self.start_logits, self.slabels_t1, self.configs.loss.t1_temperature, v_mask) \
                  + label_kdfunc(self.end_logits, self.elabels_t1, self.configs.loss.t1_temperature, v_mask)
